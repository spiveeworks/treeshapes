...
\usepackage{fullpage, amsmath, amssymb, amsthm, dsfont, qtree}
...
Invariance of course shows that the maps from orbit to orbit, are in fact maps
from orbit to individual objects.

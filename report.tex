...
\newtheorem{theorem-wip}{Theorem [WIP]}
...
It can be shown that any orbit maps that come from the action of subgroups of $\S_A\S_B$ will also be injective.
...
\begin{lemma} Exchange Property of Determinant
...
The above search was done in haskell with code at the following locations:
...
One consequence of this result is that any measurement which is a symmetric
function of the diagonal, such as the determinant or the trace, will be at
least as likely to coincide as the spectrum itself, and so these functions will
also be near-trivial.
